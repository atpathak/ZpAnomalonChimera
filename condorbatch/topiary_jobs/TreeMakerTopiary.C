...
//void TreeMakerTopiary::Loop(std::string outputFileName, float totalOriginalEvents, int sampleType,int year, int anchan, std::vector<int>  *metsys)
{
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      //Trigger decisions
      ///std::cout<<"Right before the trigger."<<std::endl;
      size_t pos = 0;
      string token;
	...
	//std::cout<<"Doing theoretical uncertainties"<<std::endl;
	//Do PDF uncertainty
	...
	//Get Pileup Weight
	//std::cout<<"We are right before pileip weights"<<std::endl;
	...
	//std::cout<<"    puw num dn "<<puwnumdwn<<std::endl;			    
      ...
      //std::cout<<"getting muons and electrons"<<std::endl;
      ...
      //std::cout<<"getting Z candidates"<<std::endl;
      unsigned int nZmumu = ZCandidatesMuMu->size();
      //std::cout<<"getting Z candidates EE"<<std::endl;
      unsigned int nZee = ZCandidatesEE->size();
      //unsigned int nZeu = 0;  
      //std::cout<<"getting Z candidates EU"<<std::endl;
      ...
      //std::cout<<"getting mumu from Z for stuff"<<std::endl;
      //Channel Flags
     ///*
	...
	int qlmu = 0;
	int qslmu = 0;
	//std::cout<<"delta R for muons"<<std::endl;
	...
	for (zit = ZCandidates->begin(); zit != ZCandidates->end(); ++zit) {
      ...
      //std::cout<<"leptonSF"<<std::endl;
      //std::cout<<"maing sure this is logging as data: "<<sampleType<<std::endl;
      //Do Lepton SF
	...
	if (passmu && not passel) {
      ...
      //std::cout<<"building higgs"<<std::endl;
	...
	for (unsigned long i =0; i < nfat; ++i) {
	  ...
	  //std::cout<<"right after jer factor"<<std::endl;
