...
if __name__=='__main__':
    ...
    parser.add_argument("-syst","--syststr",nargs="*",help="the systematic flag(s) you want in single job, space separated. Acceptable choices: pdf,qcd,prefire,pumapWeight,pumapPUnum,btag,muid,mutrg,uncl,jec,jer")
